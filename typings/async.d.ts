...
interface AsyncBooleanIterator<T> { (item: T, callback: (err: Error, truthValue: boolean) => void): void; }
...
interface Async {
    ...
    filter<T>(arr: T[], iterator: AsyncBooleanIterator<T>, callback?: (err: Error, results: T[]) => any): any;
    select<T>(arr: T[], iterator: AsyncBooleanIterator<T>, callback?: (err: Error, results: T[]) => any): any;
    filterSeries<T>(arr: T[], iterator: AsyncBooleanIterator<T>, callback?: (err: Error, results: T[]) => any): any;
    selectSeries<T>(arr: T[], iterator: AsyncBooleanIterator<T>, callback?: (err: Error, results: T[]) => any): any;
    filterLimit<T>(arr: T[], limit: number, iterator: AsyncBooleanIterator<T>, callback?: (err: Error, results: T[]) => any): any;
    selectLimit<T>(arr: T[], limit: number, iterator: AsyncBooleanIterator<T>, callback?: (err: Error, results: T[]) => any): any;
    reject<T>(arr: T[], iterator: AsyncBooleanIterator<T>, callback?: (err: Error, results: T[]) => any): any;
    rejectSeries<T>(arr: T[], iterator: AsyncBooleanIterator<T>, callback?: (err: Error, results: T[]) => any): any;
    rejectLimit<T>(arr: T[], limit: number, iterator: AsyncBooleanIterator<T>, callback?: (err: Error, results: T[]) => any): any;
    ...
    detect<T>(arr: T[], iterator: AsyncBooleanIterator<T>, callback?: (err: Error, result: T) => void): any;
    detectSeries<T>(arr: T[], iterator: AsyncBooleanIterator<T>, callback?: (err: Error, result: T) => void): any;
    detectLimit<T>(arr: T[], limit: number, iterator: AsyncBooleanIterator<T>, callback?: (err: Error, result: T) => void): any;
    sortBy<T, V>(arr: T[], iterator: AsyncResultIterator<T, V>, callback?: AsyncResultArrayCallback<T>): any;
    some<T>(arr: T[], iterator: AsyncBooleanIterator<T>, callback?: (err: Error, result: boolean) => void): any;
    someLimit<T>(arr: T[], limit: number, iterator: AsyncBooleanIterator<T>, callback?: (err: Error, result: boolean) => void): any;
    any<T>(arr: T[], iterator: AsyncBooleanIterator<T>, callback?: (err: Error, result: boolean) => void): any;
    every<T>(arr: T[], iterator: AsyncBooleanIterator<T>, callback?: (err: Error, result: boolean) => any): any;
    everyLimit<T>(arr: T[], limit: number, iterator: AsyncBooleanIterator<T>, callback?: (err: Error, result: boolean) => any): any;
    all<T>(arr: T[], iterator: AsyncBooleanIterator<T>, callback?: (err: Error, result: boolean) => any): any;
    ...
    race<T>(tasks: Array<AsyncFunction<T>>, callback?: AsyncResultArrayCallback<T>): void;
